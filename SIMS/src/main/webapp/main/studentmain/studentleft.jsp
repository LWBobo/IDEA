...
<body style="background:#fff3e1;">
    ...
    <span><img src="images/leftico01.png" /></span>个人信息
    	...
    	<ul class="menuson">
        <li><cite></cite><a href="user/stu/stuinfo.jsp" target="rightFrame">查看个人信息</a><i></i></li>
         <li><cite></cite><a href="user/pwd.jsp" target="rightFrame">修改密码</a><i></i></li>
            <li><cite></cite><a href="user/stu/stuchInfo.jsp" target="rightFrame">修改个人信息</a><i></i></li>
            <li><cite></cite><a href="user/msboard.jsp" target="rightFrame">添加留言</a><i></i></li>
        </ul>    
    </dd>
	   <dd>
	    <div class="title">
	    <span><img src="images/leftico01.png" /></span>其他信息
	    </div>
	    	<ul class="menuson">
	        <li><cite></cite><a href="user?oper=showcourse" target="rightFrame">查看课程</a><i></i></li>
	        </ul>    
	    </dd>
        <dd>
            <div class="title">
